...
4. Editing `docker-compose.yml` [**NOTE:** If plan on transcoding, check out [Advanced Configuration](templates/tree/main/docker-compose/plex#advanced-installation) before step 4]:
